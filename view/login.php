            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="assets/accountfrom/images/signin-image.jpg" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="/login" class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" placeholder="Your Email" value="<?php if ( !empty( $_GET['name'] ) ) {$_GET['name'];}?>"/>
